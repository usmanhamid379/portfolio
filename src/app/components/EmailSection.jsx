    ...
    >
      ...
      <div className="z-10">
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/usmanhamid379" target="blank">
            <Image src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link href="https://www.linkedin.com/in/usmanhamid379/" target="blank">
      ...
      <div>
        {emailSubmitted ? (
          ...
          <form className="flex flex-col" onSubmit={handleSubmit} ref={ref}>
            <div className="mb-6">
              <label
                htmlFor="email"
              ...
              <input
                ...
                placeholder="usmanhamid379@gmail.com"
              />
            </div>
            <div className="mb-6">
              <label
